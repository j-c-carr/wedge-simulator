"""
@author: Jonathan Colaco Carr (j-c-carr)

Main script for generating datasets of wedge-filtered coeval boxes.
Coeval boxes are generated by a CoevalManager object and then the wedge modes
...
def generate_coeval_dset(all_params: dict, 
    ...
    ----------
    Params:
    :all_params: All the parameters specified in config file at runtime.
    """
