...
Main script for generating datasets of wedge-filtered lightcones
Lightcones are generated by a LightconeManager object and then the wedge modes
are removed by a FourierManager object. Dataset is saved as a single h5 file.
"""
...
def save_dset_to_hf(filename: str,
    ...
    """
    Saves data to an h5py file.
    ----------
    Params
    :data:               {dset_name: data} saved as h5py Datasets
    :attrs:              Saved as h5py attributes
    :astro_param_values: Each astro_param_value is saved as a dataset in an
                         h5py Group called "astro_params"
    :astro_param_ranges: Saved as h5py attributes
    """
